...
COPY ./src/robot_behavior_tree $ROS_WS/src/robot_behavior_tree
...
CMD ["bash", "-c", "source /opt/ros/galactic/setup.bash && source /ros2_ws/install/setup.bash && ros2 launch my_launch_package launch_packages.py"]
